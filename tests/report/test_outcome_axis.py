...
golden set. `Outcome` is the summary axis above it, and it exists because reading QUALITY_WRONG_PRICE
...
def test_a_good_business_that_cannot_compound_5x_is_mixed_not_failed():
    ...
    assert OUTCOME_BY_VERDICT[Verdict.QUALITY_WRONG_PRICE] is Outcome.MIXED
...
def test_the_outcome_travels_with_the_serialised_artifact():
    ...
    report = ResearchReport(
        ...
        verdict=Verdict.QUALITY_WRONG_PRICE,
