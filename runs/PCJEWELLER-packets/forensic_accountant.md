<!-- agent: forensic_accountant@1.0.0 · answer with ONE JSON object matching the schema at the end · save it as forensic_accountant.json in this directory -->
...
```json
{
  ...
  "title": "ForensicAccountantOutput",
  "type": "object"
}
```
